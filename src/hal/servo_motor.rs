...
use esp_hal::ledc::{LowSpeed, Ledc, channel, timer};
use esp_hal::time::Rate;
use static_cell::StaticCell;
use embedded_hal::pwm::SetDutyCycle;

pub struct ServoMotor {
    // Keep ownership so the LEDC peripheral stays enabled.
    #[allow(dead_code)]
    ledc: Ledc<'static>,
    pub channel: esp_hal::ledc::channel::Channel<'static, esp_hal::ledc::LowSpeed>,
    max_duty_cycle: u32,
}

static HSTIMER0: StaticCell<esp_hal::ledc::timer::Timer<'static, esp_hal::ledc::LowSpeed>> = StaticCell::new();
...
impl ServoMotor {
    pub fn new(peripherals: ServoPeripherals) -> Self {
        ...
        let mut hstimer0 = ledc.timer::<LowSpeed>(timer::Number::Timer0);
        hstimer0
